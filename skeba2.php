...
$SHELL_CONFIG = array(
    'username' => 'https://datat.freehostia.com/ presents painted reverse php shell with space ascii art and for root or not.',
    'hostname' => 'use with caution, hint: you can check packet-storm-security for goodies.',
);
...
<html>
    ...
    <head>
        <meta charset="UTF-8" />
        <title>Call me reverse-shell if you want, but use with caution. Greez to packetstormsecurity and odix.</title>
